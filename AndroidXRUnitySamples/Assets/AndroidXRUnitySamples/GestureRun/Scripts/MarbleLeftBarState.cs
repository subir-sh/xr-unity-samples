// <copyright file="MarbleLeftBarState.cs" company="Google LLC">
//
...
{
    /// <summary>
    /// Script to handle when the marble animation is in the "Left Bar" state.
    /// </summary>
    public class MarbleLeftBarState : StateMachineBehaviour
    {
            ...
            Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            _marbleController.SetMarbleSide(MarbleSide.Left);
        }
