...
namespace AndroidXRUnitySamples.MarkerMaze
{
    ...
    public class QuaternionFilter : MonoBehaviour
    {
        ...
        private readonly float _sensorFrequency = _initialSensorFrequency;
        ...
        public Quaternion Filter(Quaternion value)
        {
            ...
            float angleDist = Math.Abs(Quaternion.Angle(value, LastValue));
            ...
            result = Quaternion.Slerp(LastValue, result, ratio);
            LastValue = result;
            return result;
        }
