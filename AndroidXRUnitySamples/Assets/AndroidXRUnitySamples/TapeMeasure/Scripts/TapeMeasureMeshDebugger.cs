// <copyright file="TapeMeasureMeshDebugger.cs" company="Google LLC">
//
...
{
    /// <summary>
    /// Show mesh debug info for Tape Measure when in debug mode.
    /// </summary>
    public class TapeMeasureMeshDebugger : MeshDebugger
    {
        /// <summary>
        ...
        {
            // Enable or disable the mesh renderer according to the debug settings.
            meshRenderer.enabled = isDebugMode;
        }
    }
}
